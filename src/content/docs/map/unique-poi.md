---
title: "如何对互联网上挖掘到的POI数据进行去重"
description: "随着互联网的发展，电子地图被越来越多地使用。在制作电子点图时，需要使用大量的POI数据（POI，Point of Interest，兴趣点），这些地址信息小则一家店铺、一个公交站等，大则一座公园、住宅小区等。目前这些POI数据的来源…"
